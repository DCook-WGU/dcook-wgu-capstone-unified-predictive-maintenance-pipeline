...
|---|---|
| Cascade Modeling Setup and Imports | Code Cell 01, Code Cell 02 |
| Define configuration mapping guards | Code Cell 03 |
| Answer | Code Cell 04, Code Cell 05, Code Cell 06, Code Cell 07, Code Cell 08, Code Cell 21, Code Cell 28, Code Cell 31, Code Cell 44, Code Cell 56 |
| Review intermediate output | Code Cell 09, Code Cell 10, Code Cell 58, Code Cell 62 |
| Start Logging for the Cascade Modeling Stage | Code Cell 11, Code Cell 12 |
...
| Prepare the Feature Matrices and Evaluation Labels | Code Cell 22 |
| Run validation guardrails | Code Cell 23 |
| Define Shared Scoring, Thresholding, and Evaluation Helpers | Code Cell 24 |
| Define percentile threshold selection | Code Cell 25 |
| Define label-based model evaluation | Code Cell 26 |
| Run Stage 1: Broad Isolation Forest Screening | Code Cell 27 |
| Build review visualization | Code Cell 29 |
| Run Stage 2: Narrow Isolation Forest Confirmation | Code Cell 30 |
| Validate That the Stage 3 Rule Sensors Exist | Code Cell 32 |
| Compute the Primary Profile Breach Count | Code Cell 33 |
| Define the Secondary Corroboration Logic | Code Cell 34 |
| Compute the Secondary Breach Count | Code Cell 35 |
| Compute Stage 3 secondary breach evidence | Code Cell 36 |
| Define the Persistence Logic | Code Cell 37 |
| Compute the Persistence Flag | Code Cell 38 |
| Define the Drift Logic | Code Cell 39 |
| Compute the Drift Flag | Code Cell 40 |
| Build the Final Stage 3 Evidence Flags and Final Cascade Decision | Code Cell 41 |
| Finalize cascade stage flag columns | Code Cell 42 |
| Build the Main Cascade Metrics | Code Cell 43 |
| Validate cascade output columns and counts | Code Cell 45, Code Cell 46 |
| Build the Cascade Summary, Threshold Records, and Truth Artifact | Code Cell 47, Code Cell 48, Code Cell 49 |
| Build detected-row review extract | Code Cell 50, Code Cell 51, Code Cell 52, Code Cell 53 |
| Finalize the Ledger and Close the Tracking Run | Code Cell 54 |
| Run Final Lineage and Consistency Checks | Code Cell 55 |
| Ask | Code Cell 57, Code Cell 61 |
| Define first-alert lookup helper | Code Cell 59, Code Cell 60 |
| Gold Cascade SQL Write Cell | Code Cell 63 |

## Code Cell 01 — Cascade Modeling Setup and Imports
...
| `)` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
| `from utils.core.config_loader import ( build_truth_config_block, set_wandb_dir_from_config, export_config_snapshot, load_pipeline_config,` | Imports a dependency or project helper used by later cells. |
| `)` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
...
## Code Cell 02 — Cascade Modeling Setup and Imports
...
- `gold`
- `gold_cascade`
- `gold_modeling_cascade_defaults`
- `info`
...
- `CONTEXT_LOG_FILE = "gold_modeling_cascade_defaults.log"`: Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream.
- `CTX = load_notebook_context( stage=CONTEXT_STAGE, dataset=CONTEXT_DATASET, mode=CONFIG_RUN_MODE, profile=CONFIG_PROFILE, logger_child_name="capstone.gold.cascade.defaults", log_fil`: Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream.
- `)`: Executes part of the notebook workflow while preserving the existing analytical behavior.
...
- `cascade_defaults_reference_profile_file_name`
- `cascade_defaults_reference_profile_path`
...
- `cascade_defaults_stage1_model_artifact_path`
- `cascade_defaults_stage1_model_file_name`
- `cascade_defaults_stage1_models_path`
...
- `# Fixed/default cascade notebook selector.`: Documents the purpose or boundary of the surrounding notebook step.
- `CASCADE_VARIANT = "default"`: Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream.
...
| `STAGE1_MODEL_FILE_NAME = str( FILENAMES["cascade_defaults_stage1_model_file_name"]` | Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream. |
| `)` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
| `STAGE2_MODEL_FILE_NAME = str( FILENAMES["cascade_defaults_stage2_model_file_name"]` | Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream. |
| `)` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
| `CASCADE_THRESHOLDS_FILE_NAME = str( FILENAMES["cascade_defaults_thresholds_file_name"]` | Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream. |
| `)` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
| `CASCADE_SUMMARY_FILE_NAME = str( FILENAMES["cascade_defaults_summary_file_name"]` | Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream. |
| `)` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
| `CASCADE_METADATA_FILE_NAME = str( FILENAMES["cascade_defaults_metadata_file_name"]` | Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream. |
| `)` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
| `CASCADE_RESULTS_FILE_NAME_CSV = str( FILENAMES["cascade_defaults_results_file_name_csv"]` | Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream. |
| `)` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
| `CASCADE_RESULTS_FILE_NAME_PICKLE = str( FILENAMES["cascade_defaults_results_file_name_pickle"]` | Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream. |
| `)` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
| `CASCADE_REFERENCE_PROFILE_FILE_NAME = str( FILENAMES["cascade_defaults_reference_profile_file_name"]` | Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream. |
| `)` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
| `GOLD_CASCADE_LEDGER_FILE_NAME = str( FILENAMES.get( "gold_cascade_defaults_ledger_file_name", "gold_cascade_defaults_ledger.jsonl", )` | Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream. |
| `)` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
| `#### #### #### #### #### #### #### #### #### #### #### #### #### #### #### ####` | Documents the purpose or boundary of the surrounding notebook step. |
...
| `103 additional statements` | Additional statements continue the same notebook step; review the notebook for exact code order. |
...
- `__gold_cascade_defaults__resolved_config`
- `build_artifact_dirs_from_config`
- `cascade_defaults_metadata_file_name`
- `cascade_defaults_reference_profile_file_name`
- `cascade_defaults_results_file_name_csv`
- `cascade_defaults_results_file_name_pickle`
- `cascade_defaults_stage1_model_file_name`
- `cascade_defaults_stage2_model_file_name`
...
- `STAGE1_MODEL_ARTIFACT_PATH = ( GOLD_CASCADE_ARTIFACT_DIRS["models"] / FILENAMES["cascade_defaults_stage1_model_file_name"]`: Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream.
- `)`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `STAGE2_MODEL_ARTIFACT_PATH = ( GOLD_CASCADE_ARTIFACT_DIRS["models"] / FILENAMES["cascade_defaults_stage2_model_file_name"]`: Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream.
- `)`: Executes part of the notebook workflow while preserving the existing analytical behavior.
...
- `CASCADE_RESULTS_PATH_CSV = ( GOLD_CASCADE_ARTIFACT_DIRS["scores"] / FILENAMES["cascade_defaults_results_file_name_csv"]`: Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream.
...
| `CASCADE_RESULTS_PATH_CSV = ( GOLD_CASCADE_ARTIFACT_DIRS["scores"] / FILENAMES["cascade_defaults_results_file_name_csv"]` | Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream. |
| `)` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
| `CASCADE_RESULTS_PATH_PICKLE = ( GOLD_CASCADE_ARTIFACT_DIRS["scores"] / FILENAMES["cascade_defaults_results_file_name_pickle"]` | Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream. |
| `)` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
| `CASCADE_THRESHOLDS_PATH = ( GOLD_CASCADE_ARTIFACT_DIRS["thresholds"] / FILENAMES["cascade_defaults_thresholds_file_name"]` | Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream. |
| `)` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
| `CASCADE_SUMMARY_PATH = ( GOLD_CASCADE_ARTIFACT_DIRS["summaries"] / FILENAMES["cascade_defaults_summary_file_name"]` | Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream. |
| `)` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
| `CASCADE_METADATA_PATH = ( GOLD_CASCADE_ARTIFACT_DIRS["metadata"] / FILENAMES["cascade_defaults_metadata_file_name"]` | Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream. |
| `)` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
| `CASCADE_REFERENCE_PROFILE_PATH = ( GOLD_CASCADE_ARTIFACT_DIRS["profiles"] / FILENAMES["cascade_defaults_reference_profile_file_name"]` | Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream. |
| `)` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
| `cascade_ledger_path = ( GOLD_CASCADE_ARTIFACT_DIRS["lineage"] / FILENAMES["gold_cascade_defaults_ledger_file_name"]` | Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream. |
| `)` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
| `CASCADE_ROW_TRACKING_DIR = GOLD_CASCADE_ARTIFACT_DIRS["row_tracking"]` | Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream. |
| `CASCADE_PLOT_DIR = GOLD_CASCADE_ARTIFACT_DIRS["plots"]` | Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream. |
...
| `CONFIG_SNAPSHOT_PATH = ( GOLD_CASCADE_CONFIG_DIR / f"{DATASET_NAME}__gold_cascade_defaults__resolved_config.yaml"` | Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream. |
| `)` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
...
## Code Cell 11 — Start Logging for the Cascade Modeling Stage
...
## Code Cell 12 — Start Logging for the Cascade Modeling Stage
...
- `gold_log_path = paths.logs / "gold_modeling_cascade_defaults.log"`: Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream.
...
| `#stage1_feature_columns = load_json(STAGE1_FEATURES_PATH)` | Documents the purpose or boundary of the surrounding notebook step. |
...
| `#stage2_feature_columns = load_json(STAGE2_FEATURES_PATH)` | Documents the purpose or boundary of the surrounding notebook step. |
...
| `#stage3_primary_rule_sensors = load_json(STAGE3_PRIMARY_PATH)` | Documents the purpose or boundary of the surrounding notebook step. |
...
| `)` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
| `#primary_profile_feature_columns: list[str] = require_str_list(` | Documents the purpose or boundary of the surrounding notebook step. |
| `# load_json(PRIMARY_PROFILE_FEATURES_PATH), # "primary_profile_feature_columns",` | Documents the purpose or boundary of the surrounding notebook step. |
| `#)` | Documents the purpose or boundary of the surrounding notebook step. |
...
| `#stage3_secondary_rule_sensors = load_json(STAGE3_SECONDARY_PATH)` | Documents the purpose or boundary of the surrounding notebook step. |
...
| `)` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
| `#secondary_profile_feature_columns: list[str] = require_str_list(` | Documents the purpose or boundary of the surrounding notebook step. |
| `# load_json(SECONDARY_PROFILE_FEATURES_PATH),` | Documents the purpose or boundary of the surrounding notebook step. |
| `# "secondary_profile_feature_columns",` | Documents the purpose or boundary of the surrounding notebook step. |
| `#)` | Documents the purpose or boundary of the surrounding notebook step. |
| `3 additional statements` | Additional statements continue the same notebook step; review the notebook for exact code order. |
...
## Code Cell 22 — Prepare the Feature Matrices and Evaluation Labels
...
## Code Cell 23 — Run validation guardrails
...
- `# =========================================================`: Documents the purpose or boundary of the surrounding notebook step.
- `# Keep these as DataFrames, not NumPy arrays.`: Documents the purpose or boundary of the surrounding notebook step.
- `# This prevents sklearn/Pylance from treating a single-column selection as a Series.`: Documents the purpose or boundary of the surrounding notebook step.
...
## Code Cell 24 — Define Shared Scoring, Thresholding, and Evaluation Helpers
...
## Code Cell 25 — Define percentile threshold selection
...
## Code Cell 26 — Define label-based model evaluation
...
## Code Cell 30 — Run Stage 2: Narrow Isolation Forest Confirmation
...
- `stage2_model = IsolationForest( random_state=STAGE2_RANDOM_STATE, n_jobs=-1, **STAGE2_FIXED_PARAMS,`: Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream.
- `)`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `stage2_model.fit(stage2_train_fit_features)`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `stage2_train_scores: np.ndarray = as_float_array( compute_anomaly_scores_isolation_forest( stage2_model, stage2_train_fit_features, ), "stage2_train_scores",`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `)`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `stage2_all_scores: np.ndarray = as_float_array( compute_anomaly_scores_isolation_forest( stage2_model, stage2_all_features, ), "stage2_all_scores",`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `)`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `stage2_threshold: float = choose_threshold_value( stage2_train_scores, STAGE2_FIXED_THRESHOLD_PERCENTILE,`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `)`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `stage2_raw_flags: np.ndarray = ( stage2_all_scores >= stage2_threshold`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `).astype(int)`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `stage2_flags: np.ndarray = ( (stage1_flags == 1) & (stage2_raw_flags == 1)`: Executes part of the notebook workflow while preserving the existing analytical behavior.
...
| `stage2_flags: np.ndarray = ( (stage1_flags == 1) & (stage2_raw_flags == 1)` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
| `).astype(int)` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
| `stage2_selected_threshold_percentile = float(STAGE2_FIXED_THRESHOLD_PERCENTILE)` | Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream. |
| `stage2_best_params = dict(STAGE2_FIXED_PARAMS)` | Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream. |
| `stage2_summary: dict[str, Any] = { "selection_mode": "fixed", "selected_threshold_percentile": float(stage2_selected_threshold_percentile), "threshold": float(stage2_threshold), "b` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
| `}` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
| `ledger.add( kind="step", step="run_cascade_stage2_fixed", message="Ran Stage 2 fixed narrow Isolation Forest using the fixed branch from the cascade config.", data={ "selection_mod` | Records or exports ledger information for stage-level traceability. |
| `)` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
...
## Code Cell 32 — Validate That the Stage 3 Rule Sensors Exist
...
## Code Cell 33 — Compute the Primary Profile Breach Count
...
## Code Cell 34 — Define the Secondary Corroboration Logic
...
## Code Cell 35 — Compute the Secondary Breach Count
...
## Code Cell 36 — Compute Stage 3 secondary breach evidence
...
## Code Cell 37 — Define the Persistence Logic
...
## Code Cell 38 — Compute the Persistence Flag
...
## Code Cell 39 — Define the Drift Logic
...
## Code Cell 40 — Compute the Drift Flag
...
## Code Cell 41 — Build the Final Stage 3 Evidence Flags and Final Cascade Decision
...
## Code Cell 42 — Finalize cascade stage flag columns
...
## Code Cell 43 — Build the Main Cascade Metrics
...
## Code Cell 45 — Validate cascade output columns and counts
...
- `cascade_defaults_stage1_model_artifact_path`
- `cascade_defaults_stage1_models_path`
- `cascade_defaults_stage2_model_artifact_path`
- `cascade_defaults_stage2_models_path`
- `cascade_defaults_stage2_selection_mode`
...
| `cascade_metadata = { "cascade_variant": CASCADE_VARIANT, "cascade_defaults_results_path_csv": str(CASCADE_RESULTS_PATH_CSV), "cascade_defaults_results_path_pickle": str(CASCADE_RES` | Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream. |
| `}` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
...
- `artifacts_root`
- `cascade_default_contract`
- `cascade_default_contract_path`
- `contract`
- `data`
- `dataset_id`
- `kind`
...
- `cascade_default_contract_path = gold_model_validation_contract_path( artifacts_root=paths.artifacts, dataset_id=DATASET_ID, model_id="cascade_default",`: Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream.
- `)`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `cascade_default_contract = build_gold_model_output_validation_contract( dataset_id=DATASET_ID, run_id=RUN_ID, model_id="cascade_default", model_label="Cascade Default", source_note`: Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream.
- `)`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `write_gold_model_output_validation_contract( contract=cascade_default_contract, output_path=cascade_default_contract_path,`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `)`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `ledger.add( kind="artifact", step="gold03a_cascade_default_validation_contract_written", message="Wrote Gold 03a cascade-default validation contract for Gold 06.", data={ "path": s`: Records or exports ledger information for stage-level traceability.
- `)`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `display(cascade_default_contract_path)`: Displays a notebook-facing result for inspection.
...
## Code Cell 51 — Build detected-row review extract
...
## Code Cell 52 — Build detected-row review extract
...
## Code Cell 53 — Build detected-row review extract
...
- `__gold__cascade_03a__row_tracking__final_detection`
- `__gold__cascade_03a__row_tracking__stage1_detection`
- `__gold__cascade_03a__row_tracking__stage2_detection`
- `__gold__cascade_03a__row_tracking__stage3_evidence_detection`
- `add`
- `artifacts`
- `cascade`
- `CASCADE_ROW_TRACKING_DIR`
...
- `f`
- `final_detected_rows_dataframe`
- `finalize_row_tracking_and_save_artifacts`
- `ledger`
- `row`
- `row_tracking_cascade_03a_final`
- `row_tracking_cascade_03a_stage1`
- `row_tracking_cascade_03a_stage2`
- `row_tracking_cascade_03a_stage3_evidence`
- `save`
...
- `logger`
- `message`
- `row_tracking_03a_final_detected_rows_path`
- `row_tracking_03a_stage1_detected_rows_path`
- `row_tracking_03a_stage2_detected_rows_path`
- `row_tracking_03a_stage3_evidence_detection_path`
- `step`

### Key Operations

- `row_tracking_03a_stage1_detected_rows_path = save_data( stage1_detected_rows_dataframe, CASCADE_ROW_TRACKING_DIR, f"{DATASET_NAME}__gold__cascade_03a__row_tracking__stage1_detectio`: Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream.
- `)`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `row_tracking_03a_stage2_detected_rows_path = save_data( stage2_detected_rows_dataframe, CASCADE_ROW_TRACKING_DIR, f"{DATASET_NAME}__gold__cascade_03a__row_tracking__stage2_detectio`: Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream.
- `)`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `row_tracking_03a_stage3_evidence_detection_path = save_data( stage3_evidence_rows_dataframe, CASCADE_ROW_TRACKING_DIR, f"{DATASET_NAME}__gold__cascade_03a__row_tracking__stage3_evi`: Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream.
- `)`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `row_tracking_03a_final_detected_rows_path = save_data( final_detected_rows_dataframe, CASCADE_ROW_TRACKING_DIR, f"{DATASET_NAME}__gold__cascade_03a__row_tracking__final_detection.c`: Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream.
- `)`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `wandb.save(str(row_tracking_03a_stage1_detected_rows_path))`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `wandb.save(str(row_tracking_03a_stage2_detected_rows_path))`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `wandb.save(str(row_tracking_03a_stage3_evidence_detection_path))`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `wandb.save(str(row_tracking_03a_final_detected_rows_path))`: Executes part of the notebook workflow while preserving the existing analytical behavior.
...
| `wandb.save(str(row_tracking_03a_stage3_evidence_detection_path))` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
| `wandb.save(str(row_tracking_03a_final_detected_rows_path))` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
| `ledger.add( kind="step", step="finalize_row_tracking_and_save_artifacts", message="Saved cascade 03A row-tracking artifacts.", data={ "row_tracking_cascade_03a_stage1": str(row_tra` | Records or exports ledger information for stage-level traceability. |
| `)` | Executes part of the notebook workflow while preserving the existing analytical behavior. |
...
## Code Cell 54 — Finalize the Ledger and Close the Tracking Run
...
- `ledger.add( kind="step", step="finalize_cascade_modeling", message="Gold cascade modeling notebook complete.", data={ "cascade_variant": CASCADE_VARIANT, "stage2_selection_mode": S`: Records or exports ledger information for stage-level traceability.
- `)`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `cascade_ledger_path = ( GOLD_CASCADE_ARTIFACT_DIRS["lineage"] / GOLD_CASCADE_LEDGER_FILE_NAME`: Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream.
- `)`: Executes part of the notebook workflow while preserving the existing analytical behavior.
...
## Code Cell 55 — Run Final Lineage and Consistency Checks
...
- `#STAGE2_SELECTION_MODE = STAGE2_CFG["fixed"]`: Documents the purpose or boundary of the surrounding notebook step.
- `STAGE2_FIXED_THRESHOLD_PERCENTILE = float( STAGE2_CFG["fixed"]["threshold_percentile"]`: Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream.
- `)`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `#print("Stage 2 selection mode:", STAGE2_SELECTION_MODE)`: Documents the purpose or boundary of the surrounding notebook step.
- `print("Stage 2 fixed threshold percentile:", STAGE2_FIXED_THRESHOLD_PERCENTILE)`: Displays a notebook-facing result for inspection.
...
- `c`: Executes part of the notebook workflow while preserving the existing analytical behavior.
...
## Code Cell 58 — Review intermediate output
...
- `display( cascade_results.loc[ cascade_results["time_index"].between(17130, 17170), [ "time_index", "machine_status", "stage1_flag", "stage2_score", "stage2_raw_flag", "stage2_flag"`: Displays a notebook-facing result for inspection.
- `)`: Executes part of the notebook workflow while preserving the existing analytical behavior.
...
## Code Cell 59 — Define first-alert lookup helper
...
## Code Cell 60 — Define first-alert lookup helper
...
- `stage_alerts = { "stage1_flag": get_first_alert_index(cascade_results, "stage1_flag"), "stage2_raw_flag": get_first_alert_index(cascade_results, "stage2_raw_flag"), "stage2_flag": `: Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream.
- `}`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `stage_alerts`: Executes part of the notebook workflow while preserving the existing analytical behavior.
...
- `{ "stage2_score_non_null_count": int(cascade_results["stage2_score"].notna().sum()), "row_count": int(len(cascade_results)),`: Executes part of the notebook workflow while preserving the existing analytical behavior.
- `}`: Executes part of the notebook workflow while preserving the existing analytical behavior.
...
- `display( cascade_results.loc[ cascade_results["time_index"].between(10380, 10460), [ "time_index", "machine_status", "stage1_flag", "stage2_score", "stage2_raw_flag", "stage2_flag"`: Displays a notebook-facing result for inspection.
- `)`: Executes part of the notebook workflow while preserving the existing analytical behavior.
...
## Code Cell 63 — Gold Cascade SQL Write Cell
...
- `CASCADE_SQL_MODEL_STAGE = "cascade_default_final"`: Assigns a value, dataframe, path, model object, configuration object, or intermediate result used downstream.
