BHN1 — BHN1 Task 3: Project Report
...
Introduction:
    Before starting this task, ensure that Tasks 1 and 2 have a passing score. If Task 1 or 2 has not yet passed, your Task 3 submission will be returned without evaluation.
...
Requirements:
    ...
    Methodology
        ...
        C. Discuss your data selection and collection process in detail, including each of the following elements:
            ...
            C1. Discuss the advantages and limitations of the dataset you used.
...
Rubric
    ...
    A:PROJECT OVERVIEW
        Not Evident
            A summary of the given elements of the capstone project is not provided.

        Approaching Competence
            The summary is missing 1 or more of the given elements or is not detailed or includes inaccurate information.
    ...
    B:PROJECT EXECUTION
        Not Evident
            A summary of the execution of the project is not provided.

        Approaching Competence
            The summary of the execution of the project is missing 1 or more of the given elements. Or the summary of 1 or more of the elements does not accurately address how the execution of each element differed from the plan developed in part B of Task 2.
    ...
    C:DATA COLLECTION PROCESS
        Not Evident
            A discussion of the data selection and data collection process is not provided.

        Approaching Competence
            The discussion of the data selection and collection process is missing 1 or more of the given elements. Or the discussion does not include specific details for each of the given elements.
    ...
    C1:ADVANTAGES AND LIMITATIONS OF THE DATASET
        Not Evident
            A discussion of the advantages and limitations of the dataset is not provided.

        Approaching Competence
            The discussion addresses either the advantages or the limitations of the dataset but not both. Or specific examples are not included for the discussed advantages and limitations. Or 1 or more of the discussed advantages or limitations does not apply to the dataset that was used.
    ...
    D:DATA EXTRACTION AND PREPARATION
        Not Evident
            An explanation of the data extraction and data preparation processes is not provided.

        Approaching Competence
            The explanation describes either the data extraction or the data preparation processes but not both. Or the explanation does not include details on why the processes were appropriate for the data. Or the explanation is missing either the tools or the techniques for 1 or both processes.
    ...
    E1:DATA ANALYSIS METHODS
        Not Evident
            A description of the data analysis methods used is not provided.

        Approaching Competence
            The description of data analysis methods is provided, but the description is either superficial or the information is inaccurate, or the methods are inappropriate for the intended goals of the project.
    ...
    E2:ADVANTAGES AND LIMITATIONS OF TOOLS AND TECHNIQUES
        Not Evident
            A discussion of the advantages and limitations of the data analysis tools and techniques used is not provided.

        Approaching Competence
            The discussion describes either the advantages or the limitations of the tools and techniques used to analyze the data but not both. Or the discussion contains inaccuracies.
    ...
    E3:APPLICATION OF ANALYTICAL METHODS
        Not Evident
            An explanation of how analytical methods were applied to the data is not provided.

        Approaching Competence
            The explanation describes how analytical methods were applied to the data, but the explanation is either superficial or does not include each step of the process. Or the explanation does not describe how all assumptions or requirements for the data were verified.
    ...
    F1:EVALUATION OF OUTPUT
        Not Evident
            An evaluation of the output of the data analytics solution or model is not provided.

        Approaching Competence
            A superficial evaluation of the output of the data analytics solution or model is provided, or the evaluation does not use calculations or metrics for accuracy.
    ...
    F2:PRACTICAL SIGNIFICANCE
        Not Evident
            An evaluation of the practical significance of the data analytics solution is not provided.

        Approaching Competence
            A superficial or inaccurate evaluation of the practical significance of the data analytics solution is provided. Or the evaluation is not supported by specific examples.
    ...
    F3:OVERALL SUCCESS
        Not Evident
            An evaluation of the overall success and effectiveness of the project is not provided.

        Approaching Competence
            A superficial or inaccurate evaluation of the overall success and effectiveness of the project is provided.
    ...
    G1:SUMMARY OF CONCLUSIONS
        Not Evident
            A summary of conclusions drawn from the analysis is not provided.

        Approaching Competence
            The summary of conclusions drawn from the analysis is inappropriate or is logically inconsistent with the dataset, chosen analytic methods, or stated goals of the project.
    ...
    G2:EFFECTIVE STORYTELLING
        Not Evident
            An explanation of why the chosen tools and graphical representations for visually communicating the findings support effective storytelling is not provided.

        Approaching Competence
            The explanation does not include logical reasons why the chosen tools and graphical representations for visually communicating the findings support effective storytelling.
    ...
    G3:RECOMMENDED COURSES OF ACTION
        Not Evident
            A submission that recommends 2 courses of action based on the findings is not provided.

        Approaching Competence
            The submission recommends 2 courses of action, but 1 or both recommendations are illogical, do not appear to be based on the findings, do not follow logically from the analysis, or do not directly address the research question or organizational need of the project.
    ...
    H:PANOPTO PRESENTATION
        Not Evident
            A link to a Panopto recording is not provided.

        Approaching Competence
            The link to a Panopto recording is provided, but the summary is missing 1 or more of the given elements. Or the summary is not appropriate for an audience of data analytics peers.
    ...
    I:EVIDENCE OF COMPLETION
        Not Evident
            A submission that provides evidence of project completion is not provided.

        Approaching Competence
            The submission attempts to provide evidence of project completion, but the element or elements submitted do not fully represent the project.
