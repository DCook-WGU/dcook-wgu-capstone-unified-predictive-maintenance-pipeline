...
The default cascade reduced the number of test alerts from `31,200` to `24,894`. This was a reduction of `6,306` alerts, or approximately `20.2%` fewer test alerts than the baseline. This result showed that the cascade architecture could filter out a portion of the baseline alert stream.
