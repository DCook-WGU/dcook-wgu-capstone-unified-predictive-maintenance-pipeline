...
def _build_filename_map(cfg: dict[str, Any]) -> dict[str, str]:
    ...
    filenames = {
        ...
        # Cascade
        "cascade_results_file_name_csv": f"{dataset_name}__gold__cascade_results.csv",
        "cascade_results_file_name_pickle": f"{dataset_name}__gold__cascade_results.pkl",
...
def _build_path_map(project_root: Path, cfg: dict[str, Any], filenames: dict[str, str]) -> dict[str, str]:
    ...
    path_map = {
        ...
        # Cascade
        "cascade_results_path_csv": str(artifacts_root / "gold" / dataset_name / filenames["cascade_results_file_name_csv"]),
        "cascade_results_path_pickle": str(artifacts_root / "gold" / dataset_name / filenames["cascade_results_file_name_pickle"]),
        "cascade_thresholds_path": str(artifacts_root / "gold" / dataset_name / filenames["cascade_thresholds_file_name"]),
        "cascade_summary_path": str(artifacts_root / "gold" / dataset_name / filenames["cascade_summary_file_name"]),
        "cascade_metadata_path": str(artifacts_root / "gold" / dataset_name / filenames["cascade_metadata_file_name"]),
        "cascade_reference_profile_path": str(artifacts_root / "gold" / dataset_name / filenames["cascade_reference_profile_file_name"]),
        "stage1_model_artifact_path": str(artifacts_root / "gold" / dataset_name / filenames["stage1_model_file_name"]),
        "stage2_model_artifact_path": str(artifacts_root / "gold" / dataset_name / filenames["stage2_model_file_name"]),
        "stage1_models_path": str(models_root / dataset_name / filenames["stage1_model_file_name"]),
        "stage2_models_path": str(models_root / dataset_name / filenames["stage2_model_file_name"]),


        # Comparision
        "comparison_path": str(artifacts_root / "gold" / dataset_name / filenames["comparison_file_name"]),
        "baseline_vs_cascade_path": str(artifacts_root / "gold" / dataset_name / filenames["baseline_vs_cascade_file_name"]),
        "baseline_vs_cascade_summary_path": str(artifacts_root / "gold" / dataset_name / filenames["baseline_vs_cascade_summary_file_name"]),
