...
def _build_filename_map(cfg: dict[str, Any]) -> dict[str, str]:
    ...
    filenames = {
        ...
        "silver_subset_profiled_file_name": f"{dataset_name}__silver_subsets__profiled_dataframe.parquet",
        "silver_subset_normal_clean_file_name": f"{dataset_name}__silver_subsets__normal_clean.parquet",
        "silver_subset_normal_contaminated_file_name": f"{dataset_name}__silver_subsets__normal_contaminated.parquet",
...
def _build_path_map(project_root: Path, cfg: dict[str, Any], filenames: dict[str, str]) -> dict[str, str]:
    ...
    path_map = {
        ...
        "silver_subsets_profiled_dataframe_data_path": str(data_root / roots["silver_train_subdir"] / filenames["silver_subset_profiled_file_name"]),
        "silver_subsets_normal_clean_data_path": str(data_root / roots["silver_train_subdir"] / filenames["silver_subset_normal_clean_file_name"]),
        "silver_subsets_normal_contaminated_data_path": str(data_root / roots["silver_train_subdir"] / filenames["silver_subset_normal_contaminated_file_name"]),
